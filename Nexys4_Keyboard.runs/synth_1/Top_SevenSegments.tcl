...
read_verilog -library xil_defaultlib {
  ...
  C:/Users/conne/OneDrive/Code/Verilog/Nexys4_Keyboard/Nexys4_Keyboard.srcs/sources_1/new/Top_SevenSegments.v
}
...
synth_design -top Top_SevenSegments -part xc7a100tcsg324-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef Top_SevenSegments.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file Top_SevenSegments_utilization_synth.rpt -pb Top_SevenSegments_utilization_synth.pb"
